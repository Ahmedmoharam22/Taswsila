      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="text-center">
          ...
          >
            ...
            <span className="text-brand-600">{t('hero.title_part2')}</span>
          </motion.h1>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="relative group">
                <MapPin 
                  className={`absolute top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-brand-600 transition-colors ${isAr ? 'right-4' : 'left-4'}`} 
                  size={20} 
                />
              <input 
  type="text" 
  placeholder={t('hero.from_placeholder')} 
  className="w-full rtl:pr-12 ltr:pl-12 py-4 bg-slate-50 border-none rounded-xl focus:ring-2 focus:ring-brand-600 outline-none"
/>
              </div>
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className={`w-full py-4 bg-slate-50 border-none rounded-xl focus:ring-2 focus:ring-brand-600 transition-all outline-none text-slate-700 ${isAr ? 'pr-12 pl-4' : 'pl-12 pr-4'}`}
                />
              </div>
